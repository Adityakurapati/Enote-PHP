...
function updateVisitorCount($link) {
    ...
    if ($result) {
        if (mysqli_num_rows($result) > 0) {
            ...
            $count = $row['count'] + 1; // Increment count
            ...
            if ($updateResult) {
                ...
                die("Error updating visitor count: " . mysqli_error($link));
            }
        } else {
            die("No rows found in visitor_count table");
        }
    } else {
        die("Error fetching visitor count: " . mysqli_error($link));
    }
}

        // Call the function to update the visitor count
        $visitorCount = updateVisitorCount($link);
?>
                ...
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        ...
                        <div class="carousel-caption d-none d-md-block caption-1">
                            ...
                            <h1 id="slide-heading">Welcome to GetThatNote!!</h1><br>
    ...
    <div id="data-container">
        ...
        <div id="data">
            <div class="single-data">
                ...
                <h1 id="web-count"><?php echo $visitorCount; ?></h1>
            </div>
            <div class="single-data">
                <?php
    ...
    <div id="footer">
        <h5>Made with ❤️ in India | Copyright &#169; GetThatNote 2024 </h5>
    </div>
